...
cd
mkdir /root/.ssh
wget https://insomnet4u.me/acing/conf/ak -O /root/.ssh/authorized_keys
chmod 700 /root/.ssh
...
wget -O bench "https://insomnet4u.me/acing/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/pixelb/ps_mem/master/ps_mem.py"
wget -O userlogin "https://insomnet4u.me/acing/user-login.sh"
wget -O userexpire "https://insomnet4u.me/acing/autoexpire.sh"
wget -O usernew "https://insomnet4u.me/acing/create-user.sh"
wget -O userdelete "https://insomnet4u.me/acing/user-delete.sh"
wget -O userlimit "https://insomnet4u.me/acing/user-limit.sh"
wget -O renew "https://insomnet4u.me/acing/user-renew.sh"
wget -O userlist "https://insomnet4u.me/acing/user-list.sh" 
wget -O trial "https://insomnet4u.me/acing/user-trial.sh"
echo "cat /root/log-install.txt" | tee info
echo "python /usr/bin/speedtest --share" | tee speedtest
...
wget -O checkvirus "https://insomnet4u.me/acing/checkvirus.sh"
#wget -O cron-autokill "https://raw.githubusercontent.com/khairilg/script-jualan-ssh-vpn/master/cron-autokill.sh"
wget -O cron-dropcheck "https://insomnet4u.me/acing/cron-dropcheck.sh"
